...
A menu-bar-only macOS 14+ utility (version **0.0.12**) that shows remaining **Cursor**, **ChatGPT**, **GLM** (z.ai / BigModel coding plan), **Grok** (consumer SuperGrok), and **OpenCode Go** subscription quota. One dark pill in the status bar, one compact popover. No Dock icon, no telemetry.
